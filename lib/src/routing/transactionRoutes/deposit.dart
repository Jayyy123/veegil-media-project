...
import 'package:veegil_bank_app/src/features/payments/deposit.dart';
                    ...
                    children: [
                      ...
                      Expanded(
                          child: Material(
                            ...
                            ),) ,child: const Text('Deposit', style: TextStyle(fontFamily:'Gotham',color: Colors.white, fontSize: 20),)),
                          )),
