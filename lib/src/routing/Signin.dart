...
import 'package:veegil_bank_app/src/features/authentication/loginAuth.dart';
...
class _SigninState extends State<Signin> {
  ...
  Future<LoginAuthentication>? _futureAuth;
  //07060942704
  @override
                    ...
                    Align(
                        ...
                        child:Column(
                          ...
                          children: [
                            ...
                            Text('Veegil Bank',style: TextStyle(fontFamily:'Gobold-Thin',color: Colors.indigo[800], fontSize: 32))
                          ],
                        )),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Opacity(opacity: 0.09,
                            child: Image.asset('assets/veegil.png', height: 263.0, width: 234.0))
                      ],
                    ),
                  ],
                ),
                      ...
                      Expanded(
                          child: Material(
                            ...
                            child: ElevatedButton(onPressed: (){
                              setState(() {
                                _futureAuth = findUser(_controllerText.text,_controllerPass.text);
                              });
  ...
  FutureBuilder<LoginAuthentication> buildFutureBuilder() {

    return FutureBuilder<LoginAuthentication>(
        future: _futureAuth,
